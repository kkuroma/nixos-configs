...
let
  ...
  keybindings = [
    ...
    { key = "ctrl+shift+b"; command = "-workbench.action.tasks.build"; when = "taskCommandsRegistered"; }
    { key = "ctrl+c"; command = "-extension.vim_ctrl+c"; when = "editorTextFocus && vim.active && vim.overrideCtrlC && vim.use<C-c> && !inDebugRepl"; }
    { key = "ctrl+alt+a"; command = "notebook.cell.insertCodeCellAboveAndFocusContainer"; when = "notebookEditorFocused && !inputFocus && !notebookOutputInputFocused"; }
    { key = "a"; command = "-notebook.cell.insertCodeCellAboveAndFocusContainer"; when = "notebookEditorFocused && !inputFocus && !notebookOutputInputFocused"; }
    { key = "ctrl+enter"; command = "-notebook.cell.insertCodeCellBelow"; when = "notebookCellListFocused && !inputFocus"; }
    { key = "ctrl+alt+b"; command = "notebook.cell.insertCodeCellBelowAndFocusContainer"; when = "notebookEditorFocused && !inputFocus && !notebookOutputInputFocused"; }
    { key = "b"; command = "-notebook.cell.insertCodeCellBelowAndFocusContainer"; when = "notebookEditorFocused && !inputFocus && !notebookOutputInputFocused"; }
    ...
    { key = "ctrl+meta+right"; command = "workbench.action.focusRightGroup"; }
    { key = "ctrl+meta+left"; command = "workbench.action.focusLeftGroup"; }
    { key = "ctrl+meta+up"; command = "workbench.action.focusAboveGroup"; }
    { key = "ctrl+meta+down"; command = "workbench.action.focusBelowGroup"; }
  ];

  keybindingsFile = pkgs.writeText "vscodium-keybindings.json" (builtins.toJSON keybindings);
in
{
  config = lib.mkIf osConfig.host.home.dev {
  programs.vscodium = {
    enable = true;
