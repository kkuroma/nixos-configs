...
let
  ...
  zfsJobs = [
    { name = "anime";    localDataset = "vault/media/anime"; remoteDataset = "tank/media/anime"; oncalendar = "*-*-* 02,08,14,20:00:00"; }
    { name = "music";    localDataset = "vault/media/music"; remoteDataset = "tank/media/music"; oncalendar = "*-*-* 01,07,13,19:00:00"; }
    { name = "research"; localDataset = "vault/research";    remoteDataset = "tank/research";    oncalendar = "*-*-* 03,09,15,21:00:00"; }
  ];
