...
lib.mkIf (config.host.services.adguard or { enable = false; }).enable {
  # Admin creds cannot be declared. To reset, stop the service and edit /var/lib/AdGuardHome/AdGuardHome.yaml
  # Gener ate with  htpasswd -bnBC 10 "" yourpassword | tr -d ':\n' for hash
